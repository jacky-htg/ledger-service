...
// 	protoc        v3.13.0
// source: ledgers/bank_account_message.proto
...
func (x *BankAccount) Reset() {
	*x = BankAccount{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ledgers_bank_account_message_proto_msgTypes[0]
...
func (*BankAccount) Descriptor() ([]byte, []int) {
	return file_ledgers_bank_account_message_proto_rawDescGZIP(), []int{0}
}
...
func (x *BankAccount) GetUpdatedBy() string {
	if x != nil {
		return x.UpdatedBy
	}
	return ""
...
var File_ledgers_bank_account_message_proto protoreflect.FileDescriptor

var file_ledgers_bank_account_message_proto_rawDesc = []byte{
	0x0a, 0x22, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x73, 0x2f, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x77, 0x69, 0x72, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x6c,
	0x65, 0x64, 0x67, 0x65, 0x72, 0x73, 0x22, 0xe1, 0x02, 0x0a, 0x0b, 0x42, 0x61, 0x6e, 0x6b, 0x41,
	...
	0x61, 0x6e, 0x79, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x62, 0x61, 0x6e, 0x6b, 0x5f, 0x6e, 0x61,
	...
	0x0b, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x1d, 0x0a, 0x0a, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20,
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x42, 0x79, 0x42, 0x3b, 0x0a, 0x23, 0x63, 0x6f,
...
var (
	file_ledgers_bank_account_message_proto_rawDescOnce sync.Once
	file_ledgers_bank_account_message_proto_rawDescData = file_ledgers_bank_account_message_proto_rawDesc
)

func file_ledgers_bank_account_message_proto_rawDescGZIP() []byte {
	file_ledgers_bank_account_message_proto_rawDescOnce.Do(func() {
		file_ledgers_bank_account_message_proto_rawDescData = protoimpl.X.CompressGZIP(file_ledgers_bank_account_message_proto_rawDescData)
	})
	return file_ledgers_bank_account_message_proto_rawDescData
}

var file_ledgers_bank_account_message_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ledgers_bank_account_message_proto_goTypes = []interface{}{
	(*BankAccount)(nil), // 0: wiradata.ledgers.BankAccount
}
var file_ledgers_bank_account_message_proto_depIdxs = []int32{
...
func init() { file_ledgers_bank_account_message_proto_init() }
func file_ledgers_bank_account_message_proto_init() {
	if File_ledgers_bank_account_message_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_ledgers_bank_account_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_ledgers_bank_account_message_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ledgers_bank_account_message_proto_goTypes,
		DependencyIndexes: file_ledgers_bank_account_message_proto_depIdxs,
		MessageInfos:      file_ledgers_bank_account_message_proto_msgTypes,
	}.Build()
	File_ledgers_bank_account_message_proto = out.File
	file_ledgers_bank_account_message_proto_rawDesc = nil
	file_ledgers_bank_account_message_proto_goTypes = nil
	file_ledgers_bank_account_message_proto_depIdxs = nil
}
